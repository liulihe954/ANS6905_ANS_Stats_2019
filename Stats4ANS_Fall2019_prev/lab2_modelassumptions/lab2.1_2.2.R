...
plot(fitted(ketosis.mod),residuals(ketosis.mod),col = "red", ylim = c(-5,5))
abline(h = 0,lty = 4)
...
plot(fitted(ketosis.mod),rstandard(ketosis.mod),col = "red",ylim = c(-5,5) )
abline( h = 0,lty = 4)
...
plot(fitted(ketosis.mod), rstudent(ketosis.mod), col = "red", ylim = c(-5,5)  )
abline(h = 0, lty = 2)
...
plot(cooks.distance(ketosis.mod), ylim = c(-2,2))
round(head(cd1),4)
