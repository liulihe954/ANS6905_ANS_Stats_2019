...
lab5.data <- read.csv("Canola trial_CRD.csv",header = T,as.is = T)
...
aov(DMI.mod) # compare between treatment variabilty vs within treatment variability
names(DMI.mod)
...
c1 <- c(0.5,0.5,-1)  # comparing the average effects of the treatment with control
