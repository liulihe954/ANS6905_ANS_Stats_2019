---
title: "ANS6905_Lab8_Latin_Square"
author: "Lihe Liu"
date: "11/12/2019"
output: 
  html_document: 
...
xtabs(cbind(ADG,Pen)~ Pen + Period + Square,
      data = ADG_data) 
# show experimental unit assignment
ftable(Period ~ Pen + TRT + Square ,data = ADG_data)
...
summary(ADG_mod_2)
ADG_mod_3 <- aov(ADG ~  TRT + Square/Pen + Period + Square, data = ADG_data)
summary(ADG_mod_3)
